...
<template>
  <div>
    <button
      type="button"
      class="fixed bottom-20 right-4 z-30 inline-flex items-center gap-2 rounded-full bg-base-100 border border-base-300 shadow-lg px-3 py-2 text-xs font-medium hover:bg-base-200 hover:shadow-xl transition-all opacity-70 hover:opacity-100"
    ...
    >
      <div
        v-if="lastSentRef"
        class="fixed bottom-32 right-4 z-30 inline-flex items-center gap-2 rounded-lg bg-success text-success-content shadow-lg px-3 py-2 text-xs font-medium"
      >
